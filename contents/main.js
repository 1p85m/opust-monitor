...
var dometrack = new ROSLIB.Topic({
    ros : ros,
    name : "/web_dome_track",
    messageType : "opust/Bool_opust",
});

var node = new ROSLIB.Topic({
    ros:ros,
    name:"/web_node",
    messageType:"opust/Status_node_msg"
});
...
var timer = new ROSLIB.Topic({
    ros:ros,
    name:"/web_timer",
    messageType:"opust/Status_timer_msg"
});

var obs = new ROSLIB.Topic({
    ros:ros,
    name:"/web_obs",
    messageType:"opust/Status_obs_msg"
});
...
var weather_humi24 = new ROSLIB.Topic({
    ros:ros,
    name:"/web_humi24",
    messageType:"opust/Float64_list_msg"
});
